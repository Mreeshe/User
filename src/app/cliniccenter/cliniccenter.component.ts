...
@Component({
  selector: 'app-cliniccenter',
  templateUrl: './cliniccenter.component.html',
  styleUrls: ['./cliniccenter.component.css'],
...
export class CliniccenterComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, private contentService:CliniccenterService) { }
